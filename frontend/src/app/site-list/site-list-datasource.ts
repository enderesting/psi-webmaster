...
export class SiteListDataSource extends DataSource<Website> {
  ...
  dataSource = new MatTableDataSource(EXAMPLE_SITES);
  ...
  private getSortedData(data: Website[]): Website[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        // case 'lastRated': return compare(+a.lastRated, +b.laslastRatedsAsc);
        default: return 0;
      }
    });
  }
...
//       switch (this.sort?.active) {
//         case 'addedDate': return compare(+a.addedDate, +b.addedDate, isAsc);
//         case 'lastRated': return compare(+a.lastRated, +b.lastRated, isAsc);
//         default: return 0;
//       }
//     });
//   }
